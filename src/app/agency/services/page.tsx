...
const INITIAL_SERVICES: Service[] = [
  {
    ...
    description:
      'Complete branding package including logo design, brand guidelines, and visual identity system.',
    category: 'Branding',
  ...
  },
  {
    ...
    description:
      'Custom website design and full-stack development with responsive design and SEO optimization.',
  ...
  },
  {
    ...
    description:
      'Social media marketing, content creation, and paid advertising strategy and management.',
  ...
  },
  {
    ...
    description:
      'Blog posts, website copy, social media content, and content marketing strategy.',
    category: 'Content',
  ...
  },
  {
    ...
    description:
      'User experience research, wireframing, prototyping, and interface design for web and mobile.',
    category: 'Web Design',
  ...
  },
  {
    ...
    description:
      'Strategic business consulting, market analysis, and growth planning for startups and enterprises.',
    category: 'Consulting',
    deliveryTime: 'Ongoing',
    status: 'available',
    agencyLabel: 'Demo Agency',

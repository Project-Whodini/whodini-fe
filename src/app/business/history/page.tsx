  ...
  const mobileMetricItems = [
    {
      ...
      value: (
        <>
          <Activity className="h-4 w-4 text-[#ff5f6d]" />
                ...
                {filteredEvents.map((event, index) => (
                  <div key={event.id} className="relative">
                    ...
                    {index !== filteredEvents.length - 1 && (
                      <div className="absolute left-5 top-10 bottom-0 w-px bg-gray-200 sm:left-6 sm:top-12" />
                    )}

                    {/* Event Item */}
                    <div className="flex items-start gap-3 sm:gap-4">
                      {/* Event Icon */}
                      <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-white border-2 border-gray-200 rounded-full flex items-center justify-center">

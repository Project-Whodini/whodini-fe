...
const INITIAL_CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    region: 'Texas',
    description:
      'Entrepreneurs and business leaders driving local economic growth',
    category: 'Business',
    memberCount: 256,
    status: 'active',
  ...
  },
  {
    ...
    region: 'New York',
    description:
      'Designers and creative professionals sharing innovative ideas',
    category: 'Creative',
    memberCount: 198,
    status: 'active',
          ...
          <Card className="border border-neutral-200 rounded-xl bg-white shadow-sm">
            <CardContent className="pt-12 pb-12 text-center">
              ...
              <CardDescription className="text-neutral-600 mb-6">
                {search
                  ? `No chapters match "${search}". Try a different search term.`

...
import { INITIAL_SERVICES } from '../services/page';
import { INITIAL_VENDORS } from '../vendors/page';
import { INITIAL_TEAM_MEMBERS } from '../team/page';
...
export const INITIAL_EVENTS: OrganizerEvent[] = [
  {
    ...
    description:
      'Annual technology conference featuring industry speakers and networking.',
    ...
    teamMemberIds: ['team_1', 'team_2', 'team_4'],
  },
  {
    id: 'org_evt_2',
    title: 'Community Wellness Workshop',
    description:
      'Free wellness workshop covering mental health and physical fitness.',
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8">
          <div>
            ...
            <p className="text-neutral-600 mt-1 text-sm sm:text-base">
              Manage professional events for{' '}
          ...
          <Card className="border border-neutral-200 rounded-xl bg-white shadow-sm">
            <CardContent className="pt-12 pb-12 text-center">
              ...
              <CardDescription className="text-neutral-600 mb-6">
                Create your first event to start organizing and managing
                registrations.
              </CardDescription>
              <Button
                onClick={() => setView('create')}

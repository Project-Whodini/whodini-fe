...
export function PermissionsModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
      <Card className="w-full sm:max-w-2xl bg-white rounded-t-2xl sm:rounded-xl shadow-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="border-t border-neutral-200 p-4 sm:p-6 flex gap-3">
          <Button
            onClick={onClose}
            variant="outline"

...
export function ShowTeamMember({
  member,
  onClose,
  onEdit,
  onUpdatePermissions,
      ...
      <CardHeader className="border-b border-neutral-200 p-4 sm:p-6">
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-start gap-3 sm:gap-4 min-w-0">
            <Avatar className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-[#ff5f6d] to-[#ffc371] text-white text-xl font-semibold shrink-0">
      ...
      <CardContent className="p-4 sm:p-6 space-y-6">
        ...
        <div className="pt-2 border-t border-neutral-200">
          <div className="text-xs text-neutral-500">
            Part of {member.organizerLabel} team
          </div>
        </div>
